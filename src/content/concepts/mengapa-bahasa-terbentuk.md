---
title: Mengapa Bahasa Terbentuk
description: Bahasa sebagai produk evolusi, kognisi, dan kultur — dari mana asalnya, bagaimana otak memprosesnya, dan apa hubungannya dengan kecerdasan buatan modern.
...
infobox:
  ...
  - label: Sub-bidang
    value: 'Evolusioner linguistik, psikolinguistik, antropologi'
  - label: Cakupan waktu
    value: '~7 juta tahun (evolusi hominid) hingga 2026'
  - label: Tokoh kunci
    value: Chomsky, Pinker, Darwin, Hockett, Vygotsky, Tomasello, Dunbar, Fitch
  - label: Gen kunci
    value: FOXP2
  - label: Area otak
    value: Area Broca (Brodmann 44/45), area Wernicke
  - label: Bahasa yang muncul
    value: Nicaraguan Sign Language (1970-an), Al-Sayyid Bedouin Sign Language (1930-an)
  - label: Koneksi AI
    value: '[LLM](/concepts/large-language-model), [Transformer](/concepts/transformer), [Embedding](/concepts/embedding), [RAG](/concepts/retrieval-augmented-generation)'
  - label: Teori dominan
    value: 'Gabungan biologis + sosial + kognitif (sintesis modern)'
  - label: Lihat juga
    value: '[LLM](/concepts/large-language-model), [AI Agent](/concepts/ai-agent), [Digital Garden](/concepts/digital-garden), [Knowledge Base](/concepts/knowledge-base), [Tan Malaka](/people/tan-malaka)'
aliases:
  - Mengapa bahasa muncul
  - Asal usul bahasa
  - Teori evolusi bahasa
  - Bahasa manusia
  - Bahasa dan evolusi
related: [large-language-model, transformer, embedding, knowledge-base, digital-garden, ai-agent]
references:
  - title: The Language Instinct
    author: Steven Pinker
    year: 1994
    note: 'Argumen bahwa bahasa adalah "instinct" — kemampuan biologis yang terinstal secara evolusioner.'
  - title: Natural Language and Natural Selection
    author: 'Steven Pinker & Paul Bloom'
    year: 1990
    note: 'Paper kunci di Behavioral and Brain Sciences — bahasa sebagai adaptasi evolusioner.'
  - title: The Evolution of Language
    author: 'W. Tecumseh Fitch'
    year: 2010
    note: 'Sintesis modern tentang evolusi bahasa, menguraikan FLB (broad) dan FLN (narrow).'
  - title: The Faculty of Language - What Is It, Who Has It, and How Did It Evolve?
    author: 'Marc Hauser, Noam Chomsky, W. Tecumseh Fitch'
    year: 2002
    note: 'Paper Science 2002 yang memisahkan FLB dan FLN.'
  - title: Origins of Language
    author: 'Jacek Fisiak (ed.)'
    year: 2005
    note: 'Kumpulan paper tentang asal-usul bahasa.'
  - title: The First Word
    author: Christine Kenneally
    year: 2007
    note: 'Buku populer tentang pencarian ilmiah asal-usul bahasa.'
  - title: Grooming, Gossip and the Evolution of Language
    author: Robin Dunbar
    year: 1996
    note: 'Argumen bahwa bahasa berevolusi dari "grooming" primata untuk mengikat kelompok sosial besar (~150 individu).'
  - title: The Origin of Speech
    author: Charles Hockett
    year: 1960
    note: 'Paper Scientific American yang memperkenalkan "design features" bahasa.'
  - title: The Symbolic Species
    author: Terrence Deacon
    year: 1997
    note: 'Teori bahwa simbol adalah kunci evolusi bahasa, bukan sinyal.'
  - title: A Middle Palaeolithic human hyoid bone
    author: 'Arensburg, Tillier, Vandermeersch, et al.'
    year: 1989
    note: 'Temuan tulang hyoid Neanderthal di Gua Kebara, Israel, ~60.000 tahun lalu.'
  - title: The derived FOXP2 variant of modern humans was shared with Neandertals
    author: 'Krause, Pääbo et al.'
    year: 2007
    note: 'Sequencing DNA Neanderthal menunjukkan versi FOXP2 yang identik dengan manusia modern.'
  - title: Children Creating Language - How Nicaraguan Sign Language Acquired a Spatial Grammar
    author: 'Ann Senghas, Marie Coppola, et al.'
    year: 2004
    note: 'Studi tentang NSL — bahasa isyarat baru yang muncul spontan di Nicaragua 1970-an.'
  - title: Thought and Language
    author: 'Lev S. Vygotsky'
    year: 1934
    note: 'Buku klasik: bahasa sebagai alat mediasi sosial-kognitif.'
---

**Bahasa** adalah salah satu fenomena paling misterius di alam semesta. Tidak ada spesies lain di Bumi — termasuk simpanse yang DNA-nya 98,7% identik dengan kita — yang memiliki sistem komunikasi dengan kompleksitas, rekursi, dan produktivitas tak terbatas seperti bahasa manusia. Pertanyaan "mengapa bahasa itu terbentuk" telah dijawab oleh banyak tradisi — dari mitologi ([Menara Babel](#teori-ilahi-divine-theory) dalam Alkitab), filsafat ([Plato](https://id.wikipedia.org/wiki/Plato)认为 bahasa adalah cerminan realitas), hingga sains modern (Chomsky, Pinker, Fitch).
...
1. **Tekanan sosial** — untuk维系 ikatan dalam kelompok yang semakin besar ([Robin Dunbar](#teori-gossip-dan-bonding-sosial-robin-dunbar): bahasa berevolusi dari "grooming" primata)
2. **Tekanan biologis** — gen [FOXP2](#gen-foxp2-the-language-gene), [area Broca](#area-broca-dan-wernicke), [tulang hyoid](#tulang-hyoid) yang memungkinkan artikulasi
3. **Tekanan kognitif** — [teori pikiran](#teori-pikiran-dan-shared-intentionality), [working memory](#working-memory-dan-recursion), dan kemampuan untuk memikirkan pikiran orang lain

Pertanyaan yang lebih menarik justru muncul di 2020-an: **apakah [Large Language Models](/concepts/large-language-model) yang belajar dari teks statistik bisa memahami bahasa?** Studi-studi emergent communication menunjukkan bahwa agen AI bisa mengembangkan "bahasa" mereka sendiri melalui permainan koordinasi. Ini menantang asumsi bahwa bahasa harus innate.

> "Language is a window into human nature." — Steven Pinker, *The Language Instinct* (1994)

> "The faculty of language is likely to have emerged quite recently in evolutionary terms, some 70,000–100,000 years ago." — [Noam Chomsky](https://en.wikipedia.org/wiki/Noam_Chomsky) (2014)
...
- **Charles Hockett** (1960): Bahasa adalah sistem komunikasi dengan 13 *design features* (lihat [bagian tersendiri](#ciri-ciri-unik-bahasa-design-features-charles-hockett)).
...
- **Arbitrariness** — hubungan antara bunyi ([signifier](https://en.wikipedia.org/wiki/Signifier)) dan makna ([signified](https://en.wikipedia.org/wiki/Signified)) adalah konvensi, bukan alami
...
Pada 2020-an, bahasa menjadi fenomena digital. Teks digital — email, pesan singkat, posting media sosial, artikel wiki — menjadi habitat baru bahasa. [Large Language Models](/concepts/large-language-model) belajar dari habitat digital ini, dan mereka menunjukkan kemampuan linguistik yang sebelumnya dianggap mustahil untuk mesin. Apakah mereka benar-benar "mengerti" bahasa, atau hanya memanipulasi simbol? Ini adalah salah satu perdebatan terbesar di [AI Agent](/concepts/ai-agent) modern.

## Ciri-ciri Unik Bahasa: Design Features (Charles Hockett)

Pada 1960, [Charles Hockett](https://en.wikipedia.org/wiki/Charles_F._Hockett) merumuskan 13 *design features* yang membedakan bahasa manusia dari sistem komunikasi hewan lain. Hockett awalnya percaya bahwa 9 fitur pertama juga dimiliki primata non-manusia (khususnya gibbon), sementara 4 fitur terakhir hanya dimiliki manusia.
...
10. **Displacement** — bisa membicarakan hal yang jauh secara ruang atau waktu (*"Kemarin di Tokyo..."*)
11. **Productivity** — bisa menghasilkan kalimat yang belum pernah ada
12. **Cultural transmission** — bahasa diturunkan secara kultural, bukan genetik
13. **Duality of patterning** — bunyi bermakna yang tak bermakna sendiri (fonem) digabung menjadi unit yang bermakna (morfem) yang digabung menjadi kalimat
...
Kajian modern (termasuk [Raviv & colleagues 2015](https://pmc.ncbi.nlm.nih.gov/articles/PMC4544681/)) mengkritik Hockett bahwa fokus pada *komunikasi* (bukan kognisi) menyesatkan. Banyak fitur komunikasi juga ada pada lebah (tarian waggle), kera, dan burung. Yang membuat bahasa manusia unik bukan fitur komunikasinya, tapi **kontennya** — pikiran, konsep, dan niat di baliknya.
...
- **Alkitab (Perjanjian Lama)**: Tuhan mengajarkan Adam nama-nama semua binatang ([Kejadian 2:19-20](https://id.wikipedia.org/wiki/Kejadian_2)). Ini mengimplikasikan bahasa adalah ciptaan, bukan evolusi.
- **Kisah Menara Babel** ([Kejadian 11:1-9](https://id.wikipedia.org/wiki/Kejadian_11)): Awalnya semua manusia berbicara satu bahasa, lalu Tuhan membingungkan bahasa mereka untuk menghentikan pembangunan Menara Babel. Ini menjadi salah satu mitos asal-mula "keragaman bahasa" di banyak budaya.
- **Tradisi Hindu (Veda)**: Bahasa (Vāc) adalah dewi yang muncul saat penciptaan.
- **Mitologi Yunani**: [Hermes](https://id.wikipedia.org/wiki/Hermes) memberikan bahasa kepada manusia sebagai alat kebohongan dan perdagangan.
- **Mitologi Norse**: [Odin](https://id.wikipedia.org/wiki/Odin) memperoleh "rune" (tulisan) dari pengorbanan dirinya sendiri.
...
- **Bow-wow theory** ([Max Müller](https://en.wikipedia.org/wiki/Max_M%C3%BCller)): Bahasa berasal dari tiruan suara alam. Kata "ayam" berasal dari suara ayam, kata "gong" dari suara gong. Kritik: kebanyakan kata bahasa tidak onomatope.
...
- **Ding-dong theory** ([Max Müller](https://en.wikipedia.org/wiki/Max_M%C3%BCller) juga): Ada resonansi harmonis antara bunyi dan makna — bunyi [m] dan [n] cocok untuk konsep "ini" atau "di sini", bunyi [i] dan [u] untuk hal kecil. Kritik: tidak ada bukti ilmiah untuk klaim ini.
...
- **Mirror neurons** (Rizzolatti et al., 1996): Neuron di [area F5](https://en.wikipedia.org/wiki/Broca%27s_area) monyet (homolog dengan [area Broca](#area-broca-dan-wernicke) pada manusia) aktif baik saat monyet melakukan tindakan maupun saat melihat monyet lain melakukannya. Ini dasar untuk **imitasi** dan **pemahaman tindakan orang lain** — dua kemampuan prasyarat bahasa.

Bukti mendukung teori gestural: bahasa isyarat ([sign language](#bahasa-isyarat-dan-kreol)) sepenuhnya kompleks dan naturalistik, menunjukkan bahwa bahasa tidak harus vokal. Lebih lanjut, anak-anak yang belajar bahasa isyarat memiliki perkembangan bahasa yang sama dengan anak-anak yang belajar bahasa lisan.
...
- **Vygotsky** (1934): Bahasa adalah alat mediasi sosial. Anak-anak pertama-tama belajar bahasa sebagai **alat sosial** (berkomunikasi dengan orang lain), dan baru kemudian menginternalisasikannya sebagai **alat berpikir** ([Vygotsky 1934](https://marxists.architexturez.net/archive/vygotsky/works/words/ch04.htm): *"development of logic in the child... is a direct function of his socialized speech"*).
...
- **[Robin Dunbar](https://en.wikipedia.org/wiki/Robin_Dunbar)** (*Grooming, Gossip and the Evolution of Language*, 1996): Bahasa berevolusi dari **grooming** primata. Primata lain维系 social bonds dengan saling grooming, tapi grooming membutuhkan waktu yang tidak scalable.
...
- **Lukisan gua tertua** (Sulawesi, ~45.000 tahun lalu, [Nature 2019](https://www.nature.com/articles/s41586-019-1806-y); Chauvet, Perancis, ~32.000 tahun lalu): Symbolic thought, mungkin naratif
...
- **[Tok Pisin](https://en.wikipedia.org/wiki/Tok_Pisin)** (Papua Nugini): Kreol berbasis bahasa Inggris. Sekarang bahasa nasional PNG.
- **[Haitian Creole](https://en.wikipedia.org/wiki/Haitian_Creole)**: Kreol berbasis bahasa Prancis. Bahasa nasional Haiti.
...
Salah satu hal paling menarik di 2020-an: bahasa menjadi **subjek utama AI**. [Large Language Models](/concepts/large-language-model) mencapai kemampuan linguistik yang sebelumnya dianggap mustahil. Ini memunculkan pertanyaan filosofis dan ilmiah baru.

### LLMs sebagai Model Bahasa

[Transformer](/concepts/transformer) — arsitektur yang mendasari [LLM](/concepts/large-language-model) — adalah **model statistik bahasa**. Ia belajar dari korpus teks besar dan memodelkan probabilitas urutan kata:
...
[Embedding](/concepts/embedding) adalah representasi kata/frasa sebagai **vektor numerik** di ruang multidimensi. Kata-kata dengan makna mirip memiliki embedding yang mirip secara geometris (jarak Euclidean kecil, sudut cosinus kecil).
...
[Transformer](/concepts/transformer) (Vaswani et al., 2017, "Attention Is All You Need") memperkenalkan **mechanism attention** — model bisa "memperhatikan" bagian relevan dari input saat memproses.

- [Context window](/concepts/context-window) — jumlah token yang bisa "diperhatikan" sekaligus — adalah keterbatasan utama LLM. Jendela yang lebih besar = lebih banyak konteks = pemahaman lebih baik.
- [Retrieval-Augmented Generation (RAG)](/concepts/retrieval-augmented-generation) — menyuntikkan informasi relevan dari [knowledge base](/concepts/knowledge-base) eksternal ke dalam context window untuk meningkatkan akurasi LLM.

### AI Agent: Bahasa sebagai Antarmuka

[AI Agent](/concepts/ai-agent) modern menggunakan bahasa sebagai **antarmuka universal** — agent menerima instruksi dalam bahasa alami, merencanakan, menggunakan tool, dan berkomunikasi dengan agent lain.
...
- [LLM](/concepts/large-language-model) modern menunjukkan bahwa **statistical learning** dari korpus besar sudah cukup untuk menghasilkan kemampuan linguistik yang kompleks. Ini **menantang asumsi innate** Chomsky.
...
### Untuk Pendidikan dan [Digital Garden](/concepts/digital-garden)
...
- [Digital garden](/concepts/digital-garden) adalah metafora untuk **[knowledge base](/concepts/knowledge-base)** yang ditumbuhkan secara iteratif — bahasa adalah "tanah" tempat taman ini tumbuh.
...
[Bahasa Indonesia](/concepts/bahasa-indonesia) adalah kasus menarik untuk dilihat dari perspektif evolusi bahasa:

- **Asal-usul**: Bahasa Indonesia (kini disebut Bahasa Indonesia) berasal dari **[Melayu Pasar](https://id.wikipedia.org/wiki/Bahasa_Melayu_Pasar)** — lingua franca yang digunakan di pelabuhan-pelabuhan kepulauan Nusantara sejak abad ke-7.
- **Standardisasi**: Bahasa ini distandardisasi oleh **[Sumpah Pemuda 1928](https://id.wikipedia.org/wiki/Sumpah_Pemuda)** sebagai bahasa persatuan, dan dianut sebagai bahasa nasional.
...
- [Wikipedia: Origin of language](https://en.wikipedia.org/wiki/Origin_of_language)
- [Wikipedia: Hockett's design features](https://en.wikipedia.org/wiki/Hockett%27s_design_features)
- [Wikipedia: Nicaraguan Sign Language](https://en.wikipedia.org/wiki/Nicaraguan_Sign_Language)
- [Wikipedia: FOXP2](https://en.wikipedia.org/wiki/FOXP2)
- [Wikipedia: Grooming, Gossip and the Evolution of Language](https://en.wikipedia.org/wiki/Grooming,_Gossip_and_the_Evolution_of_Language)
- [Stanford Encyclopedia of Philosophy: Linguistics](https://plato.stanford.edu/ENTRIES/linguistics/)
- [Stanford Encyclopedia of Philosophy: Whorfianism](https://plato.stanford.edu/ENTRIES/linguistics/whorfianism.html)
- [PMC Article on FOXP2 and Neanderthals](https://pmc.ncbi.nlm.nih.gov/articles/PMC3867335/)
- [PMC Article on Hockett critique](https://pmc.ncbi.nlm.nih.gov/articles/PMC4544681/)
- [The First Word — Christine Kenneally](https://www.thefirstword.net/)
- [Noam Chomsky: How Could Language Have Evolved?](https://chomsky.info/20140826/)

## Lihat juga

- **[Large Language Model](/concepts/large-language-model)** — model bahasa modern yang belajar dari korpus statistik
- **[Transformer](/concepts/transformer)** — arsitektur yang mendasari LLM
- **[Embedding](/concepts/embedding)** — representasi matematis dari kata/frasa
- **[Context Window](/concepts/context-window)** — jendela konteks LLM
- **[Retrieval-Augmented Generation (RAG)](/concepts/retrieval-augmented-generation)** — augmentasi LLM dengan knowledge base
- **[AI Agent](/concepts/ai-agent)** — bahasa sebagai antarmuka universal agent
- **[Knowledge Base](/concepts/knowledge-base)** — bahasa sebagai basis pengetahuan
- **[Digital Garden](/concepts/digital-garden)** — metafora pengetahuan yang ditumbuhkan
- **[Tan Malaka](/people/tan-malaka)** — penulis Madilog, menggunakan bahasa sebagai senjata revolusi
- [Bahasa Indonesia](https://id.wikipedia.org/wiki/Bahasa_Indonesia) — kasus evolusi bahasa yang berhasil dalam 100 tahun
- [Menara Babel](https://id.wikipedia.org/wiki/Menara_Babel) — mitos asal-mula keragaman bahasa
- [Charles Hockett](https://en.wikipedia.org/wiki/Charles_F._Hockett) — pencetus design features
- [Noam Chomsky](https://en.wikipedia.org/wiki/Noam_Chomsky) — pencetus Universal Grammar
- [Steven Pinker](https://en.wikipedia.org/wiki/Steven_Pinker) — pencetus Language Instinct
- [Robin Dunbar](https://en.wikipedia.org/wiki/Robin_Dunbar) — pencetus teori gossip
- [Vygotsky](https://id.wikipedia.org/wiki/Lev_Vygotsky) — pencetus teori bahasa-kognisi
- [FOXP2](https://en.wikipedia.org/wiki/FOXP2) — "language gene"
- [Nicaraguan Sign Language](https://en.wikipedia.org/wiki/Nicaraguan_Sign_Language) — bahasa yang muncul di era modern
